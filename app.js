...
app.get("/",(req,res)=>{
  Post.find({}, function(err,foundData){
    if(!err)
    {
      res.render("home",{homeText:homeStartingContent, content:foundData});
    }
  })
})
...
app.get("/posts/:postid",function(req,res){
  ...
  Post.findOne({_id: id},function(err,foundData){
    console.log(foundData);
    res.render("post",{postTitle:foundData.title , postContent:foundData.text});
  })
})
